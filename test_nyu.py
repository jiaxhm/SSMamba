...
parser.add_argument('--data_dir', metavar='DIR', default='/root/autodl-tmp/mamba_s/data_preprocessing/NYUD', help='path to images folder')
...
parser.add_argument('--output', metavar='DIR', default= './output/VMamba_stage2_nyud_double_ffm_best_png' , help='path to output folder')
...
#[0.5, 0.6, 0.7, 0.8, 0.9, 1.0, 1.1, 1.2, 1.3, 1.4]
    for scale in [0.7, 0.8]:
        assert (input_img_height * scale % 16 == 0 and input_img_width * scale % 16 == 0)
        save_path = args.output + '/ESNet_nSpixel_{0}'.format(int(input_img_height/16 * scale * input_img_width /16 * scale))
